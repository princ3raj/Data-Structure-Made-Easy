...
class Node{
public:
    long size; // size of the stack defined by this
    int top; // at initial it will point to -1
    char *s ;// integer type pointer which will point to an integer array
